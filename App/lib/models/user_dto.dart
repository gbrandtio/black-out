...
class User {
  ...
  User(String authenticationKey, String username, String firstName,
      String lastName, int savedOutages, int sharedOutages, int friends) {
    _authenticationKey = authenticationKey;
    _username = username;
    _firstName = firstName;
    _lastName = lastName;
    _savedOutages = savedOutages;
    _sharedOutages = sharedOutages;
    _friends = friends;
  }
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
        json['authentication_key'] as String,
        json['username'] as String,
        json['first_name'] as String,
        json['last_name'] as String,
        json['saved_outages'] as int,
        json['shared_outages'] as int,
        json['friends'] as int);
  }
