...
class Rest{
  ...
  static Future<Response> doPOST(String url, Map<String,String> headers, Map<String, String> body) async{
  ...
  /// headers: The headers of the request (must include the authentication key for all the requests).
  /// body: The body of the request.
  static Future<Response> doPUT(String url, Map<String,String> headers, dynamic body) async{
  ...
  /// url: The url to perform the request to.
  /// headers: The headers of the request (must include the authentication key for all the requests).
  static Future<Response> doDELETE(String url, Map<String, String> headers) async{
